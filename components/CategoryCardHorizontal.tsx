...
const categories = [
  ...
  { title: "Tower", icon: "🏹" },
  { title: "Royale", icon: "👑" },
  { title: "Roguelike", icon: "💀" },
  { title: "Retro", icon: "📼" },
  { title: "Open World", icon: "🌍" },
  { title: "Stealth", icon: "👤" },
  { title: "Hack/Slash", icon: "🗡️" },
  { title: "Turn-based", icon: "⏳" },
  { title: "Real-time", icon: "⏱️" },
  { title: "Co-op", icon: "🤝" },
  { title: "PvP", icon: "🎯" },
  { title: "Free", icon: "🎁" },
  { title: "VR", icon: "👓" },
  ...
  return (
    <section className="w-full my-10 flex justify-start">
      {/* CONTAINER DỒN TRÁI VÀ NGẮN LẠI:
         ...
         - mx-0 ml-2 để dồn hẳn sang bên trái.
      */}
