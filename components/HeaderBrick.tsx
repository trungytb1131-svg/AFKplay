...
export default function HeaderBrick() {
  return (
    <div className="col-span-4 row-span-2 bg-white rounded-2xl flex shadow-md overflow-hidden border-b-4 border-[#ff4757]">
      ...
      <Link
        href="/"
        className="flex-[2] flex flex-col items-center justify-center hover:bg-gray-50 transition-colors border-r border-gray-100 group"
      >
        ...
        <span className="text-[#1f1f1f] font-black text-[10px] tracking-tighter uppercase">
          AFKplay
        </span>
      </Link>
