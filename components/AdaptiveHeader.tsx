...
export default function AdaptiveHeader() {
  return (
    ...
    <div className="col-span-3 md:col-span-4 row-span-2 sticky top-0 z-50 bg-white rounded-[2rem] shadow-md flex border border-gray-100 overflow-hidden h-full">
      ...
      <Link
        href="/"
        className="flex-[2] flex items-center justify-center border-r border-gray-50 hover:bg-gray-50 transition-colors"
      >
        <img
      ...
      <div className="flex-1 flex flex-col">
        <button className="flex-1 flex items-center justify-center border-b border-gray-50 hover:bg-gray-50">
          <User size={20} className="text-[#008cff]" />
        </button>
        <button className="flex-1 flex items-center justify-center hover:bg-gray-50">
          <Search size={20} className="text-[#008cff]" />
        </button>
      </div>
    </div>
  );
